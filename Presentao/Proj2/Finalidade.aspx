<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Finalidade.aspx.cs" Inherits="Proj2.Finalidade" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title id="titulo">Presentão</title>
...
<body style="height: 100%; width: 100%">
    <nav class="navbar navbar-expand-sm navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="menu">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#">Finalidade</a>
            </li>
            <li class="nav-item">
    ...
    <form id="form2" runat="server">
        <div class="container">
            <div class="row">
                ...
                <div class="col">
                     <div class="form-group">
                        ...
                        <asp:TextBox class="form-control" ID="origem" runat="server"></asp:TextBox>
                    </div>
                </div>
            </div>
            ...
            <div class="align-self-center">
                <asp:GridView ID="gridFinalidade" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None">
